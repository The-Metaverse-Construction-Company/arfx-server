...
describe('@Featured Product List API', () => {
  it('should success fetch featured product list', (done) => {
    request
  ...
  it('should success fetch featured product list with pagination query filter.', (done) => {
    request
      .get('/v1/products/featured')
      .set('Authorization', `Bearer ${adminSignInResponse.token}`)
  ...
  it('should failed fetch featured product list with negative value of pageNo for  pagination query filter.', (done) => {
    request
      .get('/v1/products/featured')
      .set('Authorization', `Bearer ${adminSignInResponse.token}`)
  ...
  it('should failed fetch featured product list with negative value of limit for pagination query filter.', (done) => {
    request
      .get('/v1/products/featured')
      .set('Authorization', `Bearer ${adminSignInResponse.token}`)
      .query({limit: -20, pageNo: 1})
  ...
  it('should fetch featured product list failed due to no authorization key.', (done) => {
    request
      .get('/v1/products/featured')
