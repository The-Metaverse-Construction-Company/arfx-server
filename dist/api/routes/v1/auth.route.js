...
router.route('/login')
    .post(express_validation_1.default(auth_validation_1.login), controller.login)
    .post(express_validation_1.default(auth_validation_1.login), controller.login);
...
router.route('/refresh-token')
    .post(express_validation_1.default(auth_validation_1.refresh), controller.refresh);
/**
...
router.route('/facebook')
    .post(express_validation_1.default(auth_validation_1.oAuth), auth_1.oAuth('facebook'), controller.oAuth);
/**
 ...
 */
router.route('/google')
    .post(express_validation_1.default(auth_validation_1.oAuth), auth_1.oAuth('google'), controller.oAuth);
