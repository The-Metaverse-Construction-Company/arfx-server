...
const controller = __importStar(require("../../controllers/sign-up.controller"));
 ...
 */
router.route('/')
    .post(express_validation_1.default(auth_validation_1.register), controller.signUpRoute);
router.route('/verify')
    /// ***DEVNOTE***
