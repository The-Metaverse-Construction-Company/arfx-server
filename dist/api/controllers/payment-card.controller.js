...
exports.createCustomerIntent = async (req, res, next) => {
    try {
        ...
        const intentSecret = await payment_gateway_1.default.customer.setupIntents(stripeCustomerId);
...
exports.getCustomerPaymentMethods = async (req, res, next) => {
    try {
        ...
        const intentSecret = await payment_gateway_1.default.customer.getPaymentMethods(stripeCustomerId);
